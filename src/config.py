...
BOUNDS_BOX = "40.741527,40.648346,-73.995667,-73.870869"
...
# Use /tmp for database to avoid permission issues with sudo
STATS_DB_PATH = get_env_var("STATS_DB_PATH", "/tmp/flight_stats.db", _env_vars)
